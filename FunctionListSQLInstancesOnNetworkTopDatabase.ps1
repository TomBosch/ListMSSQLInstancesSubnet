...
function List-SQLInstancesOnNetworkToDatabase
{
 <#
    .SYNOPSIS
    Scan for MS SQL instances

    .DESCRIPTION
    Scan IP range for MS SQL instances and savin in MS SQL Server database "Inventory" and table "Instances"
    
    .PARAMETER Disklocation
    Location where you want to save log files

    .PARAMETER IPpart1
    First octet of IP address range that you want to scan

    .PARAMETER IPpart2
    Second octet of IP address range that you want to scan

    .PARAMETER IPpart3
    Third octet of IP address range that you want to scan

    .PARAMETER IPpart4
    Fourth octet of start IP address range that you want to scan

    .PARAMETER EndIPpart4
    Fourth octet of end IP address range that you want to scan

    .EXAMPLE scan IP range from 192.168.0.1 to 192.168.1.254
    List-SQLInstancesOnNetworkToDatabase -Disklocation "E:\PATH\" -IPpart1 192 -IPpart2 168 -IPpart3 1 -IPpart4 10 -EndIPpart4 254 
    #>
param
(
[string]$Disklocation,
...
#if you want to test without parameters uncomment variable and change variable Disklocation
#$Disklocation = "PATH"
$Date = get-date -Format FileDateTime
$file= $Disklocation + "instance_querys_" + $Date + "_" + $IPPart1 + "." + $IPPart2 + "." + $IPPart3 + "." + $IPPart4 + "_" + $EndIPPart4 + ".log"

#if you want to test without parameters uncomment variable and give IP address parts for start address: IP address = IPpart1 + IPpart2 + IPpart3 + IPpart4
#$IPpart1 = 192
#$IPpart2 = 168
#$IPpart3 = 0
#$IPpart4 = 10

#if you want to test without parameters uncomment variable and give part 4 for end address: IP address = IPpart1 + IPpart2 + IPpart3 + EndIPpart4
#$EndIPpart4 = 254
